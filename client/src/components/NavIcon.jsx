/** Small outline icons for sidebar (24×24 viewBox) */
export default function NavIcon({ name, className = '' }) {
  const common = { className: `nav-icon-svg ${className}`, width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.75, strokeLinecap: 'round', strokeLinejoin: 'round', 'aria-hidden': true }
  switch (name) {
    case 'dashboard':
      return (
        <svg {...common}>
    ...
    case 'timetable':
      return (
        <svg {...common}>
          ...
          <path d="M3 10h18M8 2v4M16 2v4M7 14h4M7 18h6" />
        </svg>
      )
    case 'bookReading':
      return (
