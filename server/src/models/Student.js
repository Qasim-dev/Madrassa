...
studentSchema.index(
  ...
  { unique: true, partialFilterExpression: { deletedAt: null, isDeleted: { $ne: true } } }
);
...
studentSchema.index({ tenantId: 1, isDeleted: 1, deletedAt: -1 });
studentSchema.index({ tenantId: 1, sessionId: 1, isDeleted: 1 });
